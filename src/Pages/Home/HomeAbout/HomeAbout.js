        ...
        <Container className="py-5">
            ...
            <Row className="align-items-center justify-content-center">
                ...
                <Col sm={12} lg={7} className="">
                    <div>
                        <p>Hi,
                            I am Abu Daud Hossain . I am studying for a Diploma in Computer Engineering. So, I have gained basic knowledge from my study. Also, I have gathered vast knowledge about coding, designing, markup languages, and other things that are related to this sector. I have already developed 9 projects with JavaScript and React.js.
                        </p>
